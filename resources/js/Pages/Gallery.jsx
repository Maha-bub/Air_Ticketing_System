        ...
        <>
            <div>
              ...
              &quot;responsive&quot;:{
                                    ...
                                    <div className="gallery-page__single">
                                        <div className="gallery-page__img">
                                            ...
                                            <div className="gallery-page__icon">
                                                <a className="img-popup" href="assets/images/gallery/gallery-page-1.jpg"><span className="fa fa-plus" /></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="item">
                                    <div className="gallery-page__single">
                                        <div className="gallery-page__img">
                                            ...
                                            <div className="gallery-page__icon">
                                                <a className="img-popup" href="assets/images/gallery/gallery-page-2.jpg"><span className="fa fa-plus" /></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="item">
                                    <div className="gallery-page__single">
                                        <div className="gallery-page__img">
                                            ...
                                            <div className="gallery-page__icon">
                                                <a className="img-popup" href="assets/images/gallery/gallery-page-3.jpg"><span className="fa fa-plus" /></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="item">
                                    <div className="gallery-page__single">
                                        <div className="gallery-page__img">
                                            ...
                                            <div className="gallery-page__icon">
                                                <a className="img-popup" href="assets/images/gallery/gallery-page-4.jpg"><span className="fa fa-plus" /></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="item">
                                    <div className="gallery-page__single">
                                        <div className="gallery-page__img">
                                            ...
                                            <div className="gallery-page__icon">
                                                <a className="img-popup" href="assets/images/gallery/gallery-page-5.jpg"><span className="fa fa-plus" /></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="item">
                                    <div className="gallery-page__single">
                                        <div className="gallery-page__img">
                                            ...
                                            <div className="gallery-page__icon">
                                                <a className="img-popup" href="assets/images/gallery/gallery-page-6.jpg"><span className="fa fa-plus" /></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="item">
                                    <div className="gallery-page__single">
                                        <div className="gallery-page__img">
                                            ...
                                            <div className="gallery-page__icon">
                                                <a className="img-popup" href="assets/images/gallery/gallery-page-7.jpg"><span className="fa fa-plus" /></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="item">
                                    <div className="gallery-page__single">
                                        <div className="gallery-page__img">
                                            ...
                                            <div className="gallery-page__icon">
                                                <a className="img-popup" href="assets/images/gallery/gallery-page-8.jpg"><span className="fa fa-plus" /></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="item">
                                    <div className="gallery-page__single">
                                        <div className="gallery-page__img">
                                            ...
                                            <div className="gallery-page__icon">
                                                <a className="img-popup" href="assets/images/gallery/gallery-page-9.jpg"><span className="fa fa-plus" /></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div className="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                                            <div className="footer-widget__column footer-widget__about">
                                                ...
                                                <div className="footer-widget__about-text-box">
                                                    <p className="footer-widget__about-text">Private jet charters save your time and
                                                        give
                                                        you comfort.</p>
                                                </div>
                                            </div>
                                ...
                                <div className="site-footer__bottom">
                                    <div className="site-footer__bottom-inner">
                                        <div className="site-footer__bottom-left">
                                            <p className="site-footer__bottom-text">© Copyright 2022 by <a href="#">Jetly.com</a></p>
                                        </div>
                ...
                {/* /.search-popup */}
                <a href="#" data-target="html" className="scroll-to-target scroll-to-top"><i className="icon-right-arrow" /></a>
                {/* template js */}
            </div>
