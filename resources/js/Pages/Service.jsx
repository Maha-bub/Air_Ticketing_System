                                    ...
                                    <div className="services-one__single">
                                        ...
                                        <div className="services-one__content">
                                            <div className="services-one__title-box">
                                                ...
                                                <h3 className="services-one__title"><a href="business-charter.html">Business charter</a>
                                                </h3>
                                            </div>
                                            <p className="services-one__text">Non augue egestas, commodo velit eget, tellus.</p>
                                            <div className="services-one__arrow">
                                                <a href="business-charter.html"><i className="fas fa-angle-right" /></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                                    <div className="services-one__single">
                                        ...
                                        <div className="services-one__content">
                                            <div className="services-one__title-box">
                                                <span className="services-one__sub-title">Fight For</span>
                                                <h3 className="services-one__title"><a href="private-charter.html">Private charter</a>
                                                </h3>
                                            </div>
                                            <p className="services-one__text">Non augue egestas, commodo velit eget, tellus.</p>
                                            <div className="services-one__arrow">
                                                <a href="private-charter.html"><i className="fas fa-angle-right" /></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="300ms">
                                    <div className="services-one__single">
                                        ...
                                        <div className="services-one__content">
                                            <div className="services-one__title-box">
                                                <span className="services-one__sub-title">Fight For</span>
                                                <h3 className="services-one__title"><a href="jet-rentals.html">Jet rentals</a></h3>
                                            </div>
                                            <p className="services-one__text">Non augue egestas, commodo velit eget, tellus.</p>
                                            <div className="services-one__arrow">
                                                <a href="jet-rentals.html"><i className="fas fa-angle-right" /></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="400ms">
                                    <div className="services-one__single">
                                        ...
                                        <div className="services-one__content">
                                            <div className="services-one__title-box">
                                                <span className="services-one__sub-title">Fight For</span>
                                                <h3 className="services-one__title"><a href="high-profile-people.html">High profile
                                                    people</a></h3>
                                            </div>
                                            <p className="services-one__text">Non augue egestas, commodo velit eget, tellus.</p>
                                            <div className="services-one__arrow">
                                                <a href="high-profile-people.html"><i className="fas fa-angle-right" /></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="500ms">
                                    <div className="services-one__single">
                                        ...
                                        <div className="services-one__content">
                                            <div className="services-one__title-box">
                                                <span className="services-one__sub-title">Fight For</span>
                                                <h3 className="services-one__title"><a href="music-tours.html">Music tours</a></h3>
                                            </div>
                                            <p className="services-one__text">Non augue egestas, commodo velit eget, tellus.</p>
                                            <div className="services-one__arrow">
                                                <a href="music-tours.html"><i className="fas fa-angle-right" /></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="600ms">
                                    <div className="services-one__single">
                                        ...
                                        <div className="services-one__content">
                                            <div className="services-one__title-box">
                                                <span className="services-one__sub-title">Fight For</span>
                                                <h3 className="services-one__title"><a href="sports-teams.html">Sports teams</a></h3>
                                            </div>
                                            <p className="services-one__text">Non augue egestas, commodo velit eget, tellus.</p>
                                            <div className="services-one__arrow">
                                                <a href="sports-teams.html"><i className="fas fa-angle-right" /></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
