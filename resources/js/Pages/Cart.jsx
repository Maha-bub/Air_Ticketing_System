                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div className="quantity-box">
                                                    <button type="button" className="sub"><i className="fa fa-minus" /></button>
                                                    <input type="number" id="product-1" defaultValue={1} />
                                                    <button type="button" className="add"><i className="fa fa-plus" /></button>
                                                </div>
                                            </td>
                                            <td>
                                                $10.99
                                ...
                                <div className="col-xl-4 col-lg-5">
                                    ...
                                    <div className="cart-page__buttons">
                                        <div className="cart-page__buttons-1">
                                            <a href="#" className="thm-btn">Update</a>
                                        </div>
                                        <div className="cart-page__buttons-2">
                                            <a href="checkout.html" className="thm-btn">Checkout</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
