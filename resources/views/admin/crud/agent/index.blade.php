                ...
                <div class="page-title-box d-md-flex justify-content-md-between align-items-center">
                    ...
                    <div class="">
                        <ol class="breadcrumb mb-0">
                            <li class="breadcrumb-item"><a href="{{ route('admin.agents.index') }}">Agent</a>
                            </li><!--end nav-item-->
                            <li class="breadcrumb-item"><a href="{{ route('admin.agents.index') }}">Tables</a>
                            </li><!--end nav-item-->
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a class="btn btn-sm btn-primary " href="{{ route('admin.agents.create') }}">Add New
                            Agent <i class="fas fa-arrow-right"></i></a>
