            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h4 class="card-title mb-0">Add New Airline</h4>
                    ...
                    <div class="card-body pt-0">
                        ...
                        <form action="{{ route('admin.airlines.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="text" name="name" class="form-control" value="{{ old('name') }}"
                                        placeholder="Biman Bangladesh Airlines" required>
                                </div>

                                <div class="mb-3 col-md-6">
                                    <label class="form-label">IATA Code</label>
                                    <input type="text" name="code" class="form-control text-uppercase"
                                        value="{{ old('code') }}" placeholder="BG" maxlength="10" required>
                                </div>

                                <div class="mb-3 col-md-6">
                                    <label class="form-label">Country</label>
                                    <input type="text" name="country" class="form-control"
                                        value="{{ old('country') }}" placeholder="Bangladesh">
                                </div>
                            ...
                            <button type="submit" class="btn btn-primary w-100">Save Airline</button>
                        </form>
                    </div><!--end card-body-->
                </div><!--end card-->
            </div> <!--end col-->
