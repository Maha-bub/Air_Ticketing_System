 ...
 <div class="startbar d-print-none">
     ...
     <div class="brand">
         <a href="{{ route('admin.dashboard') }}" class="logo">
             ...
             <span class="">
                 <img src="{{ !empty($siteSettings?->logo) ? asset('storage/' . $siteSettings->logo) : asset('') . 'assets/images/AirTickets_text_navy_orange.png' }}"
                     alt="logo-large" class="logo-light" style="width:210px; height:110px; object-fit:contain;">
                 <img src="{{ !empty($siteSettings?->logo) ? asset('storage/' . $siteSettings->logo) : asset('') . 'assets/images/AirTickets_text_blue.png' }}"
         ...
         <div class="startbar-collapse h-100" id="startbarCollapse" data-simplebar>
             ...
             <div class="d-flex flex-column justify-content-between h-100">
                 ...
                 <div class="sidebar-bottom p-3">
                     <a href="{{ url('/') }}" target="_blank" class="btn btn-primary w-100 mb-2">
