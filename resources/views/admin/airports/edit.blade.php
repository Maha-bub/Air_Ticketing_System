            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h4 class="card-title mb-0">Edit Airport</h4>
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="text" name="code" class="form-control text-uppercase"
                                        value="{{ old('code', $airport->code) }}" maxlength="10" required>
                                </div>
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <select name="status" class="form-select" required>
                                        <option value="active"
                                            {{ old('status', $airport->status) == 'active' ? 'selected' : '' }}>Active
                                        </option>
                                        <option value="inactive"
                                            {{ old('status', $airport->status) == 'inactive' ? 'selected' : '' }}>
                                            Inactive</option>
                                    </select>
                                </div>
                            </div>

                            <button type="submit" class="btn btn-warning w-100">Update Airport</button>
                        </form>
                    </div><!--end card-body-->
                </div><!--end card-->
            </div> <!--end col-->
