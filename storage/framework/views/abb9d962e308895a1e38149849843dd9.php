          ...
          <ul class="topbar-item list-unstyled d-inline-flex align-items-center mb-0">
              ...
              <li class="dropdown">
                  <a class="nav-link dropdown-toggle arrow-none nav-icon" data-bs-toggle="dropdown" href="#"
                      ...
                      <img src="<?php echo e(asset('')); ?>assets/images/flags/us_flag.jpg" alt=""
                          class="thumb-sm rounded-circle">
                  </a>
                  <div class="dropdown-menu">
                      <a class="dropdown-item" href="#"><img
                              src="<?php echo e(asset('')); ?>assets/images/flags/us_flag.jpg" alt="" height="15"
                              class="me-2">English</a>
                      <a class="dropdown-item" href="#"><img
                              src="<?php echo e(asset('')); ?>assets/images/flags/spain_flag.jpg" alt="" height="15"
                              class="me-2">Spanish</a>
                      <a class="dropdown-item" href="#"><img
                              src="<?php echo e(asset('')); ?>assets/images/flags/germany_flag.jpg" alt=""
                              height="15" class="me-2">German</a>
                      <a class="dropdown-item" href="#"><img
                              src="<?php echo e(asset('')); ?>assets/images/flags/french_flag.jpg" alt="" height="15"
                              class="me-2">French</a>
                  </div>
...
<?php /**PATH C:\xampp\htdocs\Air_Ticketing_System\resources\views/admin/backend/parts/topbar.blade.php ENDPATH**/ ?>