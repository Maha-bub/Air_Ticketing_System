...
<head>
    ...
    <meta charset="utf-8" />
    <title>Login |Admin |Agents|Customers Dashboard</title>
                        ...
                        <div class="col-lg-4 mx-auto">
                            <div class="card">
                                ...
                                <div class="card-body pt-0">
                                    <form class="my-4" action="<?php echo e(route('login')); ?>" method="post">
                                        <?php echo csrf_field(); ?>
                                        ...
                                        <div class="form-group row mt-3">
                                            ...
                                            <div class="col-sm-6 text-end">
                                                <a href="<?php echo e(asset('')); ?>auth-recover-pw.html"
                                    ...
                                    <div class="text-center  mb-2">
                                        <p class="text-muted">Don't have an account ? <a
                                                href="<?php echo e(asset('')); ?><?php echo e(route('register')); ?>"
...
<?php /**PATH C:\xampp\htdocs\Air_Ticketing_System\resources\views/auth/login.blade.php ENDPATH**/ ?>